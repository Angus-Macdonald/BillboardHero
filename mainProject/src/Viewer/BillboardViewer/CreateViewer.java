...
public class CreateViewer extends JFrame {
...
//            middlePanel.add(message);
            ...
            // Testing image data
            byte[] byteTest = Base64.getMimeDecoder().decode(test);
            BufferedImage img = ImageIO.read(new ByteArrayInputStream(byteTest));
//            BufferedImage enlargedImage = resizeImage(img, 50,60);

            BufferedImage image = ImageIO.read(url);
            JLabel imageInput = new JLabel(new ImageIcon(img));
